...
<div class="modal fade" id="backDropModal" data-bs-backdrop="static" tabindex="-1" style="display: none;"
  ...
  <div class="modal-dialog">
    <form action="/account/excel/upload" class="modal-content" method="post"  enctype="multipart/form-data" id="excelForm">
      <security:csrfInput/>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="fn_excelUp()">Save</button>
      </div>
    </form>
  </div>
</div>
