      ...
      <div class="modal-body">
        ...
        <div class="row g-2" style="text-align: center; display:none" id="jobStcdDiv">
          ...
          <div class="col mb-3">
            <button onclick="fn_jobStcd('1')" type="button"
              class="btn-jobStcd btn rounded-pill btn-label-primary active" value="1">진행</button>
          </div>
          <div class="col mb-3">
        ...
        <div class="row g-2" id="jobprogDiv">
          ...
          <div class="col mb-3">
            ...
            <select name="jobPriort" class="form-select" tabindex="0" id="jobPriort">
              <option value="">(선택)</option>
...
function fillDummyData() {
    ...
    document.getElementById('jobBdate').value = '2023-12-03';
    ...
    document.getElementById('jobStcd').value = '1';
}
